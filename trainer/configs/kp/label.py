...
metainfo = dict(
    classes=('LABEL',),
    dataset_name='label_KEYPOINTS_keypoint',
    keypoint_info={
...
model = dict(
    ...
    head=dict(type='RTMCCHead', in_channels=512, out_channels=4,
...
train_dataloader = dict(
    ...
    dataset=dict(type='CocoDataset', data_root='datasets/label/',
                metainfo=metainfo,
...
val_evaluator = [
    dict(type='CocoMetric', ann_file='datasets/label/val_coco.json'),
