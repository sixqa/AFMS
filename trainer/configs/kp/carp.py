...
train_dataloader = dict(
    ...
    dataset=dict(type='CocoDataset', data_root='datasets/carp/',
                metainfo=metainfo,
...
val_evaluator = [
    dict(type='CocoMetric', ann_file='datasets/carp/val_coco.json'),
