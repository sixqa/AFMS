...
metainfo = dict(
    classes=('WULI',),
    dataset_name='wuli_KEYPOINTS_keypoint',
    keypoint_info={
    ...
    skeleton_info={
        ...
        6:  {"link": ("P7", "P1"), "id": 6, "color": [255, 150, 100]}
    },
    joint_weights=[1.0] * 7,
    sigmas=[0.025] * 7,
...
model = dict(
    ...
    head=dict(type='RTMCCHead', in_channels=512, out_channels=7,
...
train_dataloader = dict(
    ...
    dataset=dict(type='CocoDataset', data_root='datasets/wuli/',
                metainfo=metainfo,
...
val_evaluator = [
    dict(type='CocoMetric', ann_file='datasets/wuli/val_coco.json'),
