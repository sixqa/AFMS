...
metainfo = dict(
    classes=('MS',),
    dataset_name='ms_KEYPOINTS_keypoint',
    keypoint_info={
        0:  {"name": "P0", "id": 0, "color": [255, 0, 0], "type": "", "swap": ""},
        1:  {"name": "P1", "id": 1, "color": [0, 255, 0], "type": "", "swap": ""},
        2:  {"name": "P2", "id": 2, "color": [0, 0, 255], "type": "", "swap": ""},
        3:  {"name": "P3", "id": 3, "color": [255, 255, 0], "type": "", "swap": ""},
        4:  {"name": "P4", "id": 4, "color": [255, 0, 255], "type": "", "swap": ""},
        5:  {"name": "P5", "id": 5, "color": [0, 255, 255], "type": "", "swap": ""},
        6:  {"name": "P6", "id": 6, "color": [255, 128, 0], "type": "", "swap": ""},
        7:  {"name": "P7", "id": 7, "color": [128, 0, 255], "type": "", "swap": ""},
        8:  {"name": "P8", "id": 8, "color": [0, 128, 255], "type": "", "swap": ""},
        9:  {"name": "P9", "id": 9, "color": [255, 0, 128], "type": "", "swap": ""},
        10:  {"name": "P10", "id": 10, "color": [128, 255, 0], "type": "", "swap": ""},
        11:  {"name": "P11", "id": 11, "color": [0, 255, 128], "type": "", "swap": ""}
    },
    skeleton_info={
        0:  {"link": ("P0", "P1"), "id": 0, "color": [255, 0, 0]},
        1:  {"link": ("P1", "P2"), "id": 1, "color": [0, 255, 0]},
        2:  {"link": ("P2", "P3"), "id": 2, "color": [0, 0, 255]},
        3:  {"link": ("P3", "P4"), "id": 3, "color": [255, 255, 0]},
        4:  {"link": ("P4", "P5"), "id": 4, "color": [255, 0, 255]},
        5:  {"link": ("P5", "P6"), "id": 5, "color": [0, 255, 255]},
        6:  {"link": ("P6", "P7"), "id": 6, "color": [255, 150, 100]},
        7:  {"link": ("P7", "P8"), "id": 7, "color": [150, 255, 100]},
        8:  {"link": ("P8", "P9"), "id": 8, "color": [100, 100, 150]},
        9:  {"link": ("P9", "P10"), "id": 9, "color": [150, 100, 100]},
        10:  {"link": ("P10", "P11"), "id": 10, "color": [150, 100, 200]},
        11:  {"link": ("P11", "P0"), "id": 11, "color": [100, 255, 150]},
        12:  {"link": ("P1", "P11"), "id": 12, "color": [150, 200, 100]},
        13:  {"link": ("P2", "P10"), "id": 13, "color": [255, 215, 0]},
        14:  {"link": ("P2", "P9"), "id": 14, "color": [0, 255, 255]},
        15:  {"link": ("P4", "P6"), "id": 15, "color": [255, 0, 0]}
    },
...
model = dict(
    ...
    head=dict(type='RTMCCHead', in_channels=512, out_channels=12,
...
train_dataloader = dict(
    ...
    dataset=dict(type='CocoDataset', data_root='datasets/ms/',
                metainfo=metainfo,
...
val_evaluator = [
    dict(type='CocoMetric', ann_file='datasets/ms/val_coco.json'),
