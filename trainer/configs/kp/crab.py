...
metainfo = dict(
    classes=('CRAB',),
    dataset_name='crab_KEYPOINTS_keypoint',
    keypoint_info={
...
train_dataloader = dict(
    ...
    dataset=dict(type='CocoDataset', data_root='datasets/crab/',
                metainfo=metainfo,
...
val_evaluator = [
    dict(type='CocoMetric', ann_file='datasets/crab/val_coco.json'),
