...
train_dataloader = dict(
    ...
    dataset=dict(type='CocoDataset', data_root='datasets/label/', metainfo=metainfo,
...
val_evaluator = dict(type='CocoMetric', ann_file='datasets/label/val_coco.json',
