...
train_dataloader = dict(
    ...
    dataset=dict(type='CocoDataset', data_root='datasets/wuli/', metainfo=metainfo,
...
val_evaluator = dict(type='CocoMetric', ann_file='datasets/wuli/val_coco.json',
