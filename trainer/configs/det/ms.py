...
train_dataloader = dict(
    ...
    dataset=dict(type='CocoDataset', data_root='datasets/ms/', metainfo=metainfo,
...
val_evaluator = dict(type='CocoMetric', ann_file='datasets/ms/val_coco.json',
